---
title: "Statistique et data mining"
...
tm_shape(carhyce_stat_sf) + # tmap object
  tm_dots(col = "group", size = 2, palette = "Set1") + # plot points
...
Milligan & Cooper[^5] dans le contexte de classification hiérarchique mettent en avant les standardisations par l'étendue dans la séparation de cluster, meilleure que le z-score.

[^5]: Milligan, G.W., Cooper, M.C. A study of standardization of variables in cluster analysis. Journal of Classification 5, 181–204 (1988). [https://doi.org/10.1007/BF01897163](https://doi.org/10.1007/BF01897163)
...
- La distance de Gower varie entre 0 (individus identiques) et 1 (totalement différents).  Il se calcul à partir de l'indice de similarité de Gower[^6] $S_g$ : $D_g=1-S_g$ avec $S_g(i,j)=\frac{\sum_{k=1}^{p} w_k \, \delta_{ij}^{(k)} \, s_{ij}^{(k)}}{\sum_{k=1}^{p} w_k \, \delta_{ij}^{(k)}}$ où :
...
[^6]: Gower, J. C. (1971). A general coefficient of similarity and some of its properties. Biometrics, 27(4), 857-871. [https://doi.org/10.2307/2528823](https://doi.org/10.2307/2528823)
