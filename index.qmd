...
## Théorème central limite {.smaller}
...
- Illustration sur le [Grimoire de Lise Vaudor](http://perso.ens-lyon.fr/lise.vaudor/grimoireStat/_book/decrire-une-variable.html#loi-normale)
...
## Intervalles de confiance de la moyenne (n>30) {.smaller}

- Selon le théorème central limite, la moyenne calculé sur un grand échantillon $m$ suit une loi approximativement normale de moyenne (de la population) $\mu$ et d'écart type $\frac{\sigma}{\sqrt{n}}$ (erreur standard).

- Or on sait que dans une distribution normale, 95% des valeurs se trouvent dans l'intervalle $[\mu-1.96\frac{\sigma}{\sqrt{m}},\mu+1.96\frac{\sigma}{\sqrt{m}}]$. On peut donc dire que la moyenne de l'échantillon a 95% de chance de se trouver dans cet intervalle. On peut remplacer 1.96 par n'importe quelle valeur critique de la loi normale pour son niveau de confiance associé (pour un niveau de confiance de 99%, la valeur critique est de 2.575).
